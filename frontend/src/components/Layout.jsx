...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex bg-soft font-body">
      ...
      `}>
        {/* Logo */}
        <div className="h-20 flex items-center justify-between px-6 border-b border-primary">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-accent to-secondary flex items-center justify-center">
        ...
        <div className="p-4 border-t border-primary">
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <button onClick={handleLogout} className="text-dark/30 hover:text-red-400 transition-colors" title="Sair">
              <FiLogOut size={18} />
            </button>
          </div>
        </div>
